...
export class ExperienceEditDialogComponent 
{
  ...
  constructor(public dialogRef: MatDialogRef<ExperienceEditDialogComponent>, @Inject(MAT_DIALOG_DATA) private experience: Experience, private experienceService: ExperienceService, private formBuilder: FormBuilder)
  {
    this.editExperienceForm = formBuilder.group(
      {
        title: [this.experience.title, Validators.compose([Validators.required, Validators.maxLength(64)])],
        ...
        companyName: [this.experience.companyName, Validators.compose([Validators.required, Validators.maxLength(64)])]
